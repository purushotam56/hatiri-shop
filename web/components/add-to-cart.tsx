...
import {
  generateWhatsAppURL,
  getQuickProductMessageWithLink,
} from "@/lib/whatsapp-templates";
import { ProductGroup, Organisation } from "@/types/product";
                ...
                {group.variants.map((variant) => {
                  ...
                  return (
                    <button
                      ...
                      onClick={() =>
                        !isDisabled && setSelectedVariant(variant.id)
                      }
                    >
                ...
                onClick={() => {
                  if (selected && !isOutOfStock) {
                    addToCart({
                      ...
                      unit: selected.unit,
                      bannerImage: (group as ProductGroup & Record<string, unknown>).bannerImage,
                      image: (group as ProductGroup & Record<string, unknown>).image,
                      images: (group as ProductGroup & Record<string, unknown>).images,
                    });
