...
export default function SellersPage() {
  ...
  useEffect(() => {
    ...
    const fetchSellers = async () => {
      try {
        const response = await fetch('http://localhost:3333/api/admin/sellers', {
      ...
      <div className="max-w-7xl mx-auto px-4 py-6 space-y-6">
        <div className="flex justify-between items-center">
          <div className="flex flex-col gap-2">
            ...
            <p className="text-default-500">Manage seller accounts and permissions</p>
          </div>
        ...
        {loading ? (
          ...
          <Card>
            <CardHeader className="flex flex-col gap-2">
              <p className="text-lg font-semibold">All Sellers ({sellers.length})</p>
            </CardHeader>
            <CardBody>
                ...
                {sellers.map((seller) => (
                  ...
                  >
                    <div>
                      ...
                      <p className="text-sm text-default-500">📱 {seller.mobile}</p>
                    </div>
