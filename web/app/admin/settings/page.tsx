          ...
          <>
            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="text-default-500">
                Configure system-wide settings for all sellers
              </p>
            </div>
            ...
            <Card>
              <CardHeader className="flex flex-col items-start px-6 py-4 border-b border-divider">
                ...
                <p className="text-sm text-default-500 mt-1">
                  Set the default free trial period for new sellers
                </p>
              </CardHeader>
              <CardBody className="gap-6 p-6">
                  ...
                  <div className="space-y-3">
                    <div>
                      ...
                      <p className="text-xs text-default-500 mt-1">
                        Number of days new sellers get to try Hatiri for free
                      </p>
                    </div>
                    <div className="flex items-center gap-4">
                      ...
                      >
                        ...
                        <SelectItem key="14">14 days (Recommended)</SelectItem>
                  ...
                  {settings && (
                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                      ...
                      <p className="text-xs text-blue-700 mt-2">
                        This applies to all new seller sign-ups after this
                        change is saved.
                      </p>
                    </div>
                  )}
                ...
                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mt-6">
                  ...
                  <ul className="text-xs text-yellow-800 mt-2 space-y-1 list-disc list-inside">
                    <li>
                      New sellers automatically get the configured number of
                      free trial days upon sign-up
                    </li>
                    <li>
                      During the trial period, sellers have access to all
                      features
                    </li>
                    <li>
                      When the trial ends, sellers need to upgrade to a paid
                      plan to continue
                    </li>
                    <li>
                      Changes to this setting apply to future sign-ups only
                    </li>
                  </ul>
                </div>
              </CardBody>
