    ...
    <main className="min-h-screen bg-default-50">
      ...
      <div className="max-w-7xl mx-auto px-4 py-6 space-y-6">
        <div className="flex flex-col gap-2">
          ...
          <p className="text-default-500">View and manage all orders across all organizations</p>
        </div>
        ...
        {loading ? (
          ...
          <Card>
            <CardHeader className="flex flex-col gap-2">
              <p className="text-lg font-semibold">All Orders ({orders.length})</p>
            </CardHeader>
            <CardBody>
              <Table aria-label="Global orders table">
                ...
                <TableBody>
                  {orders.map((order) => (
                    <TableRow key={order.id} className="hover:bg-default-100 cursor-pointer">
