...
export default function SellerDashboardPage() {
  ...
  // Single effect to handle auth check and data fetching
  useEffect(() => {
    ...
    const fetchDashboard = async () => {
      try {
        const data = await apiEndpoints.getSellerDashboard(
          String(orgId),
          token,
        );
      ...
      <div className="max-w-7xl mx-auto px-4 py-8 space-y-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <Link href={`/seller/${orgId}/customers`}>
            ...
            >
              <svg
                className="w-8 h-8 mb-2 text-purple-600"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
                <path
                  d="M12 4.354a4 4 0 110 5.292M15 21H3v-2a6 6 0 0112 0v2zm0 0h6v-2a6 6 0 00-9-5.673"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  strokeWidth={2}
                />
          ...
          <Link href={`/seller/${orgId}/settings`}>
            ...
            >
              <svg
                className="w-8 h-8 mb-2 text-orange-600"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
            ...
            {recentOrders.length === 0 ? (
              ...
              <div className="space-y-2">
                {recentOrders.map((order) => (
                  <Link
                    key={order.id}
                    href={`/seller/${orgId}/orders/${order.id}`}
                  >
